    ...
    try:
        ...
        if user.status == "kicked":
            await bot.send_message(
                ...
                text="Sorry Sir, You are Banned to use me. Contact my [OWNER](https://t.me/SUDIPSAHA06).",
        ...
        await bot.send_message(
            chat_id=cmd.from_user.id,
            text="Something went Wrong, or buy any bot Contact me [OWNER](https://t.me/SUDIPSAHA06).",
            disable_web_page_preview=True
        )
        return 200
    return 200
